              ...
              drivers.map(
                (driver) =>
                  ...
                  sheet.addRow({
                    ...
                    status: item?.status === "active" ? "on the way" : "Completed",
              ...
              <table className="min-w-max w-full table-auto">
                <thead>
                  <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                    {user.name === "admin" && (
                      <th className="py-4 px-8 text-center">Owner</th>
                    )}
                    <th className="py-4 px-8 text-center">Departure Point</th>
                    <th className="py-4 px-8 text-center">Destination</th>
                    <th className="py-4 px-8 text-center">Vehicle</th>
                    <th className="py-4 px-8 text-center">Driver</th>
                    <th className="py-4 px-8 text-center">Situation</th>
                    <th className="py-4 px-8 text-center">Transactions</th>
                  </tr>
                </thead>
