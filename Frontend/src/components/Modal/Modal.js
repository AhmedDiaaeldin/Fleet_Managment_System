                    ...
                    <div className="w-full md:w-1/2 h-5/6 flex flex-row items-center justify-center rounded-lg space-x-5">
                      <div className="flex flex-col space-y-5">
                        ...
                        <div class="flex items-center justify-center rounded-xl bg-white p-4 shadow-md md:w-48">
                          ...
                          <div class="ml-4">
                            <h2 class="text-sm text-gray-600">Destination</h2>
                            <p class="mt-2 font-wider font-semibold">
                              {item.destination}
                            </p>
                          </div>
                      ...
                      <div className="flex flex-col space-y-5">
                        ...
                        <div class="flex items-center justify-center rounded-xl bg-white p-4 shadow-md md:w-48">
                          ...
                          <div class="ml-4">
                            <h2 class="text-sm text-gray-600">Route Status</h2>
                            <p class="mt-2 font-wider font-semibold">
                              {item.status === "active"
                                ? "on the road"
                                : "Completed"}
                      ...
                      <div className="flex flex-col space-y-5">
                        ...
                        <div class="flex items-center justify-center rounded-xl bg-white p-4 shadow-md md:w-48">
                          ...
                          <div class="ml-4">
                            <h2 class="text-sm text-gray-600">The total time</h2>
                            <p class="mt-2 font-wider font-semibold">
                              {item.duration}
                            </p>
                          </div>
                      ...
                      driver.id === item.driver_id && (
                        <div class="w-2/3 h-5/6 p-6 border border-gray-100 rounded-lg">
                          ...
                          <p class="leading-relaxed text-base">
                            {item.starting} - {item.destination} works on the route.
                          </p>
